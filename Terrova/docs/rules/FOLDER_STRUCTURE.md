...
Terrova follows a modular monorepo structure optimized for Next.js App Router and Solana smart contracts.
...
```
hooks/
├── use-terrova.ts         # Program interaction hook
...
```
lib/
├── terrova/               # Program-specific utilities
│   ├── client.ts          # Solana client wrapper
│   ├── types.ts           # TypeScript types
│   ├── terrova.types.ts  # Generated IDL types
...
3. **Add types** in `lib/terrova/types.ts`

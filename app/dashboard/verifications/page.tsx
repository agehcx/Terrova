          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent className="sm:max-w-lg">
              <DialogHeader>
                ...
                <DialogDescription>Submit a new claim to the Terrova network for verification.</DialogDescription>
              </DialogHeader>
              <div className="flex flex-col gap-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-medium">Bounty (TRV)</label>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="mt-1 text-2xl font-bold">
              {allVerifications.reduce((acc, v) => acc + Number(v.bounty), 0)} TRV
            </p>
          </CardContent>
        </Card>
      </div>

...
export default function RewardsPage() {
  ...
  const dynamicRewards = evidences
    ...
    .map(e => ({
      id: `RWD-${e.id}`,
      type: "Evidence Verification",
      amount: 15, // simulated 15 PROOF per evidence
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Track and claim your PROOF token rewards
          </p>
        </div>
        <Button className="gap-2" size="lg">
          <Wallet className="h-5 w-5" />
          Claim All Rewards ({dynamicStats.pendingRewards} PROOF)
        </Button>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="p-4">
            ...
            <p className="mt-1 text-2xl font-bold text-primary">
              {dynamicStats.totalEarned.toLocaleString()} PROOF
            </p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="mt-1 text-2xl font-bold">{dynamicStats.pendingRewards} PROOF</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="mt-1 text-2xl font-bold">+{dynamicStats.thisMonth} PROOF</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>How you earn PROOF tokens</CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            <div className="flex items-center justify-between rounded-lg bg-muted/50 p-4">
              ...
              <div className="text-right">
                <p className="font-semibold">892 PROOF</p>
            ...
            <div className="flex items-center justify-between rounded-lg bg-muted/50 p-4">
              ...
              <div className="text-right">
                <p className="font-semibold">245 PROOF</p>
            ...
            <div className="flex items-center justify-between rounded-lg bg-muted/50 p-4">
              ...
              <div className="text-right">
                <p className="font-semibold">147 PROOF</p>
            ...
            {pendingRewards.length === 0 ? (
              ...
              pendingRewards.map((reward) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span className="font-semibold text-primary">+{reward.amount} PROOF</span>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Complete history of your PROOF token rewards</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-3">
            {allRewards.map((reward) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="font-semibold text-primary">+{reward.amount} PROOF</p>
                  <p className="text-xs text-muted-foreground">
                    ~${reward.amount * 2} USD
                  </p>
                </div>

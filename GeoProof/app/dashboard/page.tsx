...
export default function DashboardPage() {
  ...
  const metrics: Metric[] = [
    ...
    { label: "Pending Rewards", value: earnings.toString(), subtext: "PROOF" },
  ]
              ...
              <Link href="/dashboard/rewards">
                <Button variant="outline" className="h-auto w-full justify-start gap-3 px-4 py-3">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-muted-foreground">{earnings} PROOF available</div>
                  </div>
                </Button>
              </Link>

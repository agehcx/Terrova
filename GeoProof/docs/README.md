# Introduction to GeoProof

Welcome to the official documentation for **GeoProof**, the decentralized physical infrastructure network (DePIN) for agricultural insurance verification on Solana.

## What is GeoProof?

GeoProof bridges the gap between smart contract insurance policies and real-world agricultural events. By incentivizing a decentralized network of node operators to capture, hash, and verify geospatial evidence (like crop damage photos or drought conditions), GeoProof enables fully automated, trustless claims settlement.
...
By utilizing Solana's high-throughput architecture, GeoProof allows:
...
* **Node Operators:** Stake PROOF tokens to join the network. They submit geotagged evidence and earn bounties for accurate reporting.

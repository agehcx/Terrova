...
GeoProof uses GitHub Actions for continuous integration and deployment. All code must pass CI checks before merging.
...
|-------------|-----|--------|-------------|
| Production | geoproof.io | main | Yes |
| Staging | staging.geoproof.io | develop | Yes |

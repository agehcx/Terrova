...
describe('NodeCard', () => {
  it('renders node information', () => {
    ...
    expect(screen.getByText('1,000 PROOF')).toBeInTheDocument()
...
```typescript
// contracts/tests/geoproof.ts
import * as anchor from '@coral-xyz/anchor'
import { Program } from '@coral-xyz/anchor'
import { GeoProof } from '../target/types/geoproof'
...
describe('geoproof', () => {
  ...
  const program = anchor.workspace.GeoProof as Program<GeoProof>

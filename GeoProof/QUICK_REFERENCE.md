# GeoProof - Quick Reference Card

**Keep this handy while developing GeoProof!**
...
export function MyComponent() {
  const {
    client,              // GeoProofClient instance
...
### GeoProofClient Methods

```typescript
const client = new GeoProofClient(connection, wallet, programId);
...
```tsx
const { error, clearError } = useGeoProof();

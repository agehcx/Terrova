...
export const GEOPROOF_PROGRAM_ID = new PublicKey(
...
export interface ProtocolConfig {
  minStake: number        // Minimum PROOF tokens to stake
...
/**
 * Format PROOF token amount (assumes 9 decimals like SOL)
 */
...
/**
 * Parse PROOF token amount to lamports
 */

...
**Core Program** (`contracts/programs/geoproof/src/lib.rs`)
- 5 main instructions:
...
**GeoProofClient** (`lib/geoproof/client.ts`)
...
**TypeScript Types** (`lib/geoproof/geoproof.types.ts`)
...
**useGeoProof Hook** (`hooks/useGeoProof.ts`)
...
**Seed Data** (`lib/geoproof/seed-data.ts`)
...
- Email: support@geoproof.io (when available)
...
- **GitHub**: https://github.com/yourusername/geoproof
- **Documentation**: See GETTING_STARTED.md and ARCHITECTURE.md
- **Demo**: http://localhost:3001 (after `pnpm dev`)
- **Contract Code**: `contracts/programs/geoproof/src/lib.rs`

---

**Ready to launch GeoProof? Start with `pnpm dev` and explore the full application!**
